      ...
      <div class="row">
          <div class="col-lg-12">
            <ul class="breadcrumbs">
                ...
                <li><a href="<?php echo e(route('front.campaign')); ?>"><?php echo e(__('Campaign Products')); ?></a>
                </li>
              </ul>
          </div>
      </div>
...
<?php echo $__env->make('master.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dealmulr/public_html/core/resources/views/front/campaign.blade.php ENDPATH**/ ?>