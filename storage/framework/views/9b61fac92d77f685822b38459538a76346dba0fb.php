        ...
        <div class="row padding-top-1x  mb-4">
          <div class="col-sm-6">
            ...
            <ul class="list-unstyled">
              <li><span class="text-muted"><?php echo e(__('Name')); ?>: </span><?php echo e($ship['ship_first_name']); ?> <?php echo e($ship['ship_last_name']); ?></li>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="row mt-4">
          <div class="col-12">
            ...
            <div class="payment-methods" id="paymentMethodsAll">
              <?php
              ...
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="payment-methods" id="paymentMethodsCashOnDelivery">
              <?php
              $gateways1 = DB::table('payment_settings')->whereStatus(1)->get();
              ?>
              
              <?php $__currentLoopData = $gateways1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gateway1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <?php if(PriceHelper::CheckDigitalPaymentGateway()): ?>
               
              <?php if($gateway1->unique_keyword != 'cod'): ?>
              <div class="single-payment-method">
                <a class="text-decoration-none " href="#" data-bs-toggle="modal" data-bs-target="#<?php echo e($gateway->unique_keyword); ?>">
                    <img class="" src="<?php echo e(asset('assets/images/'.$gateway->photo)); ?>" alt="<?php echo e($gateway->name); ?>" title="<?php echo e($gateway->name); ?>">
                    <p><?php echo e($gateway1->name); ?></p>
                </a>
              </div>
              <?php endif; ?>
  ...
  <script>
  var checkoutType = document.getElementById("checkoutType").value;
  if(checkoutType == "cod"){
    document.getElementById("paymentMethodsAll").style.visibility="hidden"; 
    document.getElementById("paymentMethodsAll").style.display="none"; 
  }else{
        document.getElementById("paymentMethodsCashOnDelivery").style.visibility="hidden"; 
        document.getElementById("paymentMethodsCashOnDelivery").style.display="none"; 
  }
...
<?php echo $__env->make('master.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dealmulr/public_html/core/resources/views/front/checkout/payment.blade.php ENDPATH**/ ?>