            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                       ...
                       <div class="form-group">
                        <label for="tax_id"><?php echo e(__('Payment Type')); ?> *</label>
                        <select name="checkout_type" id="checkout_type" class="form-control">
                            <option value="allbanks"><?php echo e(__('Continue With All Banks')); ?></option>
                            <option value="cod"><?php echo e(__('Cash On Delivery')); ?></option>
...
<?php echo $__env->make('master.back', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dealmulr/public_html/core/resources/views/back/item/create.blade.php ENDPATH**/ ?>