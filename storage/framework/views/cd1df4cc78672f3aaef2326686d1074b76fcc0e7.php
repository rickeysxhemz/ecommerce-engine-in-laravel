        ...
        <?php if(session()->has('domin_url')): ?>
            <div class="alert alert-success" style="background-color: #d4edda;" id="license_alert">
                ...
                <strong>
                    ...
                    <br>
                    Author Contact : geniusdevs24@gmail.com 
                </strong>
            </div> 
        <?php endif; ?>
...
<?php echo $__env->make('vendor.installer.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dealmulr/public_html/core/resources/views/vendor/installer/environment-wizard.blade.php ENDPATH**/ ?>